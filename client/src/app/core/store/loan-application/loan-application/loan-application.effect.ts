...
export class LoanApplicationEffects {
  ...
  get_loan_application$ = createEffect(() => this.actions$
  ...
  change_cc_status$ = createEffect(() => this.actions$
  ...
  submit_loan_application$ = createEffect(() => this.actions$
  ...
  disburse_loan_application$ = createEffect(() => this.actions$
