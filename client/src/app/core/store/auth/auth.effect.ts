...
export class AuthEffects {
  ...
  login$ = createEffect(() => this.actions$.pipe(ofType(authActions.AUTHENTICATE),
  ...
  check_auth$ = createEffect(() => this.actions$.pipe(ofType(authActions.CHECK_AUTH),
  ...
  save_token$ = createEffect(() => this.actions$
  ...
  purge_auth$ = createEffect(() => this.actions$.pipe(ofType(authActions.PURGE_AUTHENTICATE),
    map((action: NgRxAction) => {
  ...
  navigateHome$ = createEffect(() => this.actions$.pipe(ofType(authActions.LOGIN_SUCCEEDED),
    tap(() => {
      this.authService.checkAsAuthenticated();
