...
export class AccountingEntriesComponent implements OnInit, OnDestroy {
  ...
  public multipleTransactionDebitAccounts: any[] = [];
  public multipleTransactionCreditAccounts: any[] = [];
  public isDebitTransactionAccount = false;
  public totalAmountAccounts!: number;

  private multipleTransactionDebitAccountsValue: any[] = [];
  private multipleTransactionCreditAccountsValue: any[] = [];
  ...
  selectTransactionTemplateValue(value: any) {
