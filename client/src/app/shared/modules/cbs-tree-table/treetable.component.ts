...
export class TreeTableComponent {
  ...
  @ContentChild(HeaderComponent, {static: false}) header: HeaderComponent= new HeaderComponent();

  @ContentChild(FooterComponent, {static: false}) footer: FooterComponent= new FooterComponent();

  @ContentChildren(ColumnComponent) columns: QueryList<ColumnComponent>= new QueryList<ColumnComponent>();
}
...
export class HighlightDirective {
  ...
  private highlight(color: string) {
    if (this.el?.parentElement?.style) {
