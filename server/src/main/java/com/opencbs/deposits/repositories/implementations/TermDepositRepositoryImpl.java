package com.opencbs.deposits.repositories.implementations;
...
import com.opencbs.deposits.repositories.TermDepositRepositoryCustom;
...
public class TermDepositRepositoryImpl extends BaseRepository<TermDeposit> implements TermDepositRepositoryCustom {
    ...
    public Page<TermDepositSimplified> getAllWithSearch(String searchString, Pageable pageable) {
        ...
        for (Tuple t : tuples) {
            ...
            dto.setStatus(t.get("status", com.opencbs.deposits.domain.enums.TermDepositStatus.class));
