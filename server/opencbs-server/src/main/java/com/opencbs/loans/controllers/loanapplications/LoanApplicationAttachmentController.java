...
public class LoanApplicationAttachmentController {
        private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory
                        .getLogger(LoanApplicationAttachmentController.class);
        ...
        public AttachmentDto post(@PathVariable Long loanApplicationId,
                ...
                logger.info("Received attachment upload request for loan application: {}, {}",
                                file.getOriginalFilename(),
                                comment);
                LoanApplicationAttachment attachment = loanApplicationAttachmentService.create(file, loanApplication,
                                UserHelper.getCurrentUser(), comment);
