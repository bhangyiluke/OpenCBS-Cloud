...
@Service
public class UserService extends BaseHistoryService<User, Long, Integer>
        implements CrudService<User>, UserDetailsService {
    ...
    public Page<User> findAllTeller(String searchString, Pageable pageable) {
        ...
        List<User> allTellers = this.userRepository
                .findDistinctByIsSystemUserFalseAndRolePermissionsNameIn(pageable,
                        Arrays.asList(User.HEAD_TELLER, User.TELLER))
                .getContent();
