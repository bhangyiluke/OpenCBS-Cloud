...
public class PermissionService {
    ...
    public boolean existsByRoleAndPermission(Role role,Long permissionId) {
        return this.permissionRoleRepository.existsByRoleIdAndPermissionId(role.getId(),permissionId);
    }
}
