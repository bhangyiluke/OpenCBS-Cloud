...
public class JasperReportService implements ReportService<ExcelTemplate, ExcelRequest> {
    ...
    public JasperReportService(TemplateProperty templateProperty,
                               DataSource dataSource,
                               JasperExporterHelper jasperExporterHelper) throws Exception {
        this.templateProperty = templateProperty;
        this.dataSource = dataSource;
        this.jasperExporterHelper = jasperExporterHelper;
        // this.init();
    }
    @PostConstruct
    ...
    private void loadTemplate(File report) throws Exception {
        log.info("Load jasper report: {}", report.getPath());
    ...
    private JasperPrint getReport(ExcelRequest request, JasperExporter exporter) throws Exception {
        ...
        if (jasperTemplate==null) {
            throw new IllegalArgumentException(String.format("Not found template with name: %s", request.getReportName()));
        }
