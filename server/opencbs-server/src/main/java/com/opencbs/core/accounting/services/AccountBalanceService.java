...
public class AccountBalanceService {
    ...
    public Optional<AccountBalance> create(Long accountId, BigDecimal amount, LocalDate date, Boolean fromDebit) {
        ...
        if (!additionalInformationOfAccount.containsKey(accountId)) {
            additionalInformationOfAccount.put(accountId, accountAdditionalInformationRepository.findById(accountId).orElseThrow(() ->
                    new IllegalArgumentException("AccountAdditionalInformation with accountId:: " + accountId + " not found")));
        }
