        ...
        public AttachmentDto post(@PathVariable long groupId,
                ...
                Group group = this.groupService
                                ...
                                .orElseThrow(() -> new ResourceNotFoundException(
                                                String.format("Group not found (ID=%d).", groupId)));

                GroupAttachment attachment = groupAttachmentService.create(attachmentUploadDto.getFile(), group,
                                UserHelper.getCurrentUser(), attachmentUploadDto.getComment());
