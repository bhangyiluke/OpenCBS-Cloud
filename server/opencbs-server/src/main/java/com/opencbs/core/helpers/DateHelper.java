...
public class DateHelper {
    ...
    */
    ...
    public static LocalDateTime dateToLocalDateTime(ZonedDateTime dateTime) {
        return LocalDateTime.ofInstant(Instant.ofEpochMilli(dateTime.toInstant().toEpochMilli()), ZoneId.systemDefault());
    }
    ...
    public static LocalDate toLocalDate(LocalDateTime dateTime) {
        ...
        // return LocalDate.of(dateTimeUtc.getYear(), dateTimeUtc.getMonthValue(), dateTimeUtc.getDayOfMonth());
    }
